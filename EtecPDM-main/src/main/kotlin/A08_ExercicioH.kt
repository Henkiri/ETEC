...
fun anos(data: Int)
{
    ...
    printlv("1) O numero de anos escolhido tem: $meses meses, $dias dias, $horas horas , $minutos minutos e $segundos segundos")
}
...
{
    var palavraTrocada = palavra.replace("a" "A", "x"")
    palavra trocada = palavra.uppercase
